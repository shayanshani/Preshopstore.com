<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master.Master" AutoEventWireup="true" CodeBehind="AddCity.aspx.cs" Inherits="PreShop.AdminPortal.AddCity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add/Edit Cities</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row">
                        <div class="col-lg-12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#AddEditCity">Add New City</button>
                            <!-- Pop up -->
                            <div class="modal fade bs-example-modal-sm" role="dialog" aria-hidden="true" id="AddEditCity">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">
                                                <asp:Label ID="lblPopUpCity" runat="server">Add New City</asp:Label>
                                            </h4>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="form-group">
                                                            <label>
                                                                City:&nbsp;
                                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" BorderColor="#FF66FF" SetFocusOnError="true" ControlToValidate="txtCityName" ErrorMessage="*" ForeColor="Red" ValidationGroup="validation"></asp:RequiredFieldValidator>
                                                            </label>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# Convert.ToInt32(Eval("[isActive]"))==1 ? "Active" : Convert.ToInt32(Eval("[isActive]"))==2 ? "Deleted" : "InActive" %>
                                            ...
                                            <td class="center">
                                                <asp:LinkButton ID="btnEdit" runat="server" OnClick="btnEdit_Click" CommandArgument='<%# Eval("[CityID]") %>'><span class="fa fa-pencil" style="font-size: 16px!important;"></span></asp:LinkButton>&nbsp;|
                                            <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure you want to delete this record?');" CommandArgument='<%# Eval("[CityID]") %>'><span class="fa fa-trash" style="font-size: 16px!important;"></span></asp:LinkButton>
                                            </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
    ...
    <script>
        $(document).ready(function () {
            $('#AddEditCity').on('hide.bs.modal', function (e) {
                var hfCityID = $('#<%= hfCityID.ClientID%>');
                $('#<%= ddlStatus.ClientID%>').val("-1").trigger('change');
                $('#<%= txtCityName.ClientID%>').val(null);
                hfCityID.val(null);
            });
        });
