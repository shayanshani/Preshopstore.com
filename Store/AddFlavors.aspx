<%@ Page Title="" Language="C#" MasterPageFile="~/Store/Master.Master" AutoEventWireup="true" CodeBehind="AddFlavors.aspx.cs" Inherits="PreShop.ManageStoreAttributes.Store.AddFlavors" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div id="demo-form2" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <asp:DropDownList ID="ddlProduct" runat="server" class="select2_single form-control" TabIndex="2" onchange="change(this.value)">
                            </asp:DropDownList>
                            <ul class="parsley-errors-list filled">
                                <li class="parsley-required">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Flavor:<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <asp:TextBox runat="server" ID="txtFlavorName" class="form-control col-md-7 col-xs-12" TabIndex="1"></asp:TextBox>

                            <ul class="parsley-errors-list filled">
                                <li class="parsley-required">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtFlavorName" ErrorMessage="Enter Flavor Name" ValidationGroup="validation"></asp:RequiredFieldValidator>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <asp:HiddenField ID="hfFlavorID" runat="server" />
        </div>
    </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <asp:Repeater ID="rptFlavor" runat="server">
                                <ItemTemplate>
                                    <tr class="even gradeX">
                                        ...
                                        <td class="center" id="thActions" runat="server">
                                            <asp:LinkButton ID="btnEdit" runat="server" OnClick="btnEdit_Click" CommandArgument='<%# Eval("FlavorID") %>'><span class="fa fa-edit" style="font-size: 22px!important;"></span></asp:LinkButton>
                                            <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%# Eval("FlavorID") %>'><span class="fa fa-trash" style="font-size: 22px!important;"></span></asp:LinkButton>
                                        </td>
                                    </tr>
